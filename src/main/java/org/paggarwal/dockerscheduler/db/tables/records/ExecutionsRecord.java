...
public class ExecutionsRecord extends UpdatableRecordImpl<ExecutionsRecord> implements Record8<Integer, Integer, byte[], byte[], String, Integer, Timestamp, Timestamp> {

	private static final long serialVersionUID = 922814024;
	 ...
	 */
	@Override
	public Row8<Integer, Integer, byte[], byte[], String, Integer, Timestamp, Timestamp> fieldsRow() {
	 ...
	 */
	@Override
	public Row8<Integer, Integer, byte[], byte[], String, Integer, Timestamp, Timestamp> valuesRow() {
	 ...
	 */
	@Override
	public ExecutionsRecord values(Integer value1, Integer value2, byte[] value3, byte[] value4, String value5, Integer value6, Timestamp value7, Timestamp value8) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public ExecutionsRecord(Integer id, Integer taskId, byte[] stdout, byte[] stderr, String environmentVariables, Integer status, Timestamp startedOn, Timestamp endedOn) {
		super(Executions.EXECUTIONS);
